...
plt.title("The impact of a correction factor on an example filter method")
plt.xlabel("The number of features")
plt.ylabel("The score/correction factor")
plt.legend(['score filter method', 'correction factor', 'FS_score filter method'])
plt.axis([0, 300, 0, 1])
#plt.xscale("log")
plt.show()
