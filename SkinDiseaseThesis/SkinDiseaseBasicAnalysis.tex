...
\begin{document}
	...
	\begin{table}[]
		...
		\begin{tabular}{l|ll}
			\textbf{Biomedical relation} & \textbf{Explanation}                                                 & \textbf{\begin{tabular}[c]{@{}l@{}}Examples for gene \\ "discoidin domain receptor tyrosine kinase 1"\end{tabular}}                      \\ \hline
			Process                      & Biomedical processes the gene product is involved with               & \begin{tabular}[c]{@{}l@{}}- regulation of cell growth\\ - peptidyl-tyrosine autophosphorylation\\ - lactation\end{tabular}              \\
			Cellular location            & The gene product is located in or part of certain cellular locations & \begin{tabular}[c]{@{}l@{}}- extracellular region \\ - plasma membrane \\ - extracellular vesicular exosome\end{tabular}                 \\
			Molecular reaction           & A molecular reaction the gene product is involved with               & \begin{tabular}[c]{@{}l@{}}- nucleotide binding\\ - collagen binding\\ - protein tyrosine kinase collagen receptor activity\end{tabular}
		\end{tabular}
	\end{table}
