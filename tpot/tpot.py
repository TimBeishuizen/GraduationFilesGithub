...
# START NEW IMPORTS
from .config.classifier_high_fs import high_FS_classifier_config_dict
# END NEW IMPORTS
...
class HighFSTPOTClassifier(TPOTClassifier):
    """TPOT estimator for classification problems with high feature selection."""

    default_config_dict = high_FS_classifier_config_dict