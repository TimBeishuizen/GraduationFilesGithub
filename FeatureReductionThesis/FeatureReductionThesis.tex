...
\end{table}
	...
	\subsection{TPOT integration}
	\label{subsec:TPOTIntegration}
...
\begin{table}[]
	\begin{tabular}{ll|ll|ll}
		...
		\multirow{4}{*}{\textbf{Datasets}}  & MicroOrganisms & -0.36                                                        & -0.37                                                                  & 0.79               & 0.73                                                                   \\
		& Arcene         & -9.08                                                        & -9.13                                                                  & 0.76               & 0.76                                                                   \\
		& RSCTC          & -53.76                                                       & -53.72                                                                 & 0.20               &                                                                        \\
		& Psoriasis      & -53.76                                                       & -53.77                                                                 &                    &                                                                       
	\end{tabular}
\end{table}
	\section{Results}
	\label{sec:Results}
